                ...
                <div class="card">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-line">
                            ...
                            {{Form::text('imageTitle','',['class'=>'form-control', 'placeholder'=>'Image Title'])}}
                                ...
                                {{Form::button('<i class="material-icons">add</i> <span>Add Photo</span>', ['type'=>'submit','class'=>'btn btn-success waves-effect'])}}
